...
class ShowDonationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Donation _donation = donationList[donationIndex];
    List<Marker> allMarkers = [
      Marker(
          ...
          position: LatLng(_donation.hospitalLocation.latitude,
              _donation.hospitalLocation.longitude))
    ];
    return Scaffold(
      appBar: AppBar(
                      ...
                      child: Column(
                        children: <Widget>[
                          Column(children: <Widget>[
                            ...
                            MyListTile(
                              title: 'Hospital: ${_donation.hospitalName}',
                            ...
                            Container(
                              ...
                              child: GoogleMap(
                                ...
                                initialCameraPosition: CameraPosition(
                                    target: LatLng(
                                        _donation.hospitalLocation.latitude,
                                        _donation.hospitalLocation.longitude),
                                    zoom: 16.0),
                              ),
                            ),
